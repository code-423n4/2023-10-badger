...
/**************************** Diff Block Start ****************************
diff --git a/packages/contracts/contracts/EBTCToken.sol b/packages/contracts/contracts/EBTCToken.sol
index 6187aeb..9bee994 100644
--- a/packages/contracts/contracts/EBTCToken.sol
+++ b/packages/contracts/contracts/EBTCToken.sol
@@ -275,7 +275,7 @@ contract EBTCToken is IEBTCToken, AuthNoOwner, PermitNonce {
 
         unchecked {
             // Safe because of the check above
-            _balances[account] = cachedBalance - amount;
+            _balances[account] = cachedBalance;
         }
