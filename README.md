...
|[/packages/contracts/contracts/LiquidationLibrary.sol](https://github.com/code-423n4/2023-10-badger/blob/main/packages/contracts/contracts/LiquidationLibrary.sol)|700|Contains liquidation-related functions. Split off due to maximum contract size, delegateCalled by CdpManager.|
...
```
yarn && git submodule init && git submodule update && solc-select use 0.8.17 && solc-select use 0.8.17 && cd packages/contracts/ && medusa fuzz
```
