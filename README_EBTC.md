...
### A Chainlink Upgrade Could cause a temporary DOS

If Chainlink performs an upgrade, due to how PhaseId and RoundId are calculated, the oracle will fail in fetching the previous round data.
